...
/* Operator << */
/***************/
std::ostream& Eaagles::Clips::operator<< (std::ostream& o, const DataObject& s)
  {
   s.print(o);
   return o;
  }
...
/* Operator << */
/***************/
std::ostream& Eaagles::Clips::operator<< (std::ostream& o, const Value& s)
  {
   s.print(o);
   return o;
  }
