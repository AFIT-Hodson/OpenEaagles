...
const char * Eaagles::Lua::LuaAction::className = "LuaAction";                 
const Luna<Eaagles::Lua::LuaAction>::FunctionType Eaagles::Lua::LuaAction::methods[] =      
{
    {NULL, NULL}
};

const Luna<Eaagles::Lua::LuaAction>::PropertyType Eaagles::Lua::LuaAction::properties[] =   
{
